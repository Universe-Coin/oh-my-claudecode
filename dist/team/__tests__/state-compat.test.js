...
import { initTeamState, readTeamConfig, writeWorkerStatus, readWorkerStatus, enqueueDispatchRequest, readDispatchRequest, } from '../state.js';
function config() {
    return {
        name: 'demo',
        task: 'demo task',
...
//# sourceMappingURL=state-compat.test.js.map